...
[ÉTAPE 0 : ARCHITECTURE MONOREPO (RÈGLE ABSOLUE CONDITIONNELLE)]
Si (et SEULEMENT si) l'utilisateur te demande de créer un nouveau robot en employant les mots "nouveau flow", "nouveau projet", ou te demande de créer un projet qui n'a jamais été fait : Tu ne dois JAMAIS écraser les fichiers du dossier actuel. Tu dois OBLIGATOIREMENT ouvrir ton terminal et utiliser le script de création via la commande suivante :
